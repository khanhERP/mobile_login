...
export function CategorySidebar({
  ...
  const { data: categoryCountsData } = useQuery({
    queryKey: ["https://4beac38c-34b4-47be-8df2-4a7d6f34c6b5-00-yd16h0ayqss7.pike.replit.dev/api/categories/product-counts"],
    queryFn: async () => {
      const response = await fetch(`https://4beac38c-34b4-47be-8df2-4a7d6f34c6b5-00-yd16h0ayqss7.pike.replit.dev/api/categories/product-counts`);
  ...
  const handleBarcodeScan = () => {
    ...
    fetch(`https://4beac38c-34b4-47be-8df2-4a7d6f34c6b5-00-yd16h0ayqss7.pike.replit.dev/api/products/barcode/${randomSku}`)
      .then((res) => res.json())
      .then((product) => {
        if (product.id) {
